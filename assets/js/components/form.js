...
class UILabel extends HTMLElement {
    connectedCallback() {
        ...
        addFormClasses(this, "text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70");
    }
}
...
class UIInput extends HTMLElement {
    connectedCallback() {
        ...
        addFormClasses(input, "flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400 disabled:cursor-not-allowed disabled:opacity-50 border-gray-300");
